    ...
    public partial class First : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocentModule", x => new { x.DocentenId, x.ModulesId });
                    table.ForeignKey(
                        name: "FK_DocentModule_Docent_DocentenId",
                        column: x => x.DocentenId,
                        principalTable: "Docent",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DocentModule_Module_ModulesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocentModule_ModulesId",
                table: "DocentModule",
                column: "ModulesId");
